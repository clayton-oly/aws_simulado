...
export default function Simulado() {
  ...
  const [results, setResults] = useState<Result[]>([]); // Armazena as respostas selecionadas
  const [finished, setFinished] = useState(false); // Indica se o simulado foi finalizado
  const [questions, setQuestions] = useState<Question[]>([]); // Armazena as perguntas embaralhadas
